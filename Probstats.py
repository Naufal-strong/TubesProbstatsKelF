...
file_path = r"C:\Users\USER HP\Downloads\Jawaban Survei Form Responses 1.csv"
if not os.path.exists(file_path):
    raise FileNotFoundError("File CSV tidak ditemukan. Periksa path file!")

data = pd.read_csv(file_path)

col_status = data.columns[3]   # Status keaktifan organisasi
